  ...
  (function(_PureComponent) {
    ...
    function TocItem() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(TocItem)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
  ...
  (function(_PureComponent2) {
    ...
    function ReactReader(props) {
      ...
      _this2 = _possibleConstructorReturn(
        this,
        _getPrototypeOf(ReactReader).call(this, props)
      );
      ...
      _defineProperty(_assertThisInitialized(_this2), "onTocChange", function(
        toc
      ) {
      ...
      _defineProperty(_assertThisInitialized(_this2), "setLocation", function(
        loc
      ) {
...
ReactReader.defaultProps = {
  loadingView: _react.default.createElement(
    "div",
    {
